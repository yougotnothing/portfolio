<script lang="ts">
  ...
  onMount(() => {
    ...
    gsap.from('.header-shadow', { 
      ...
      onComplete: () => {
        gsap.to('.header-shadow', {
          stagger: 0.1,
          duration: 1,
          boxShadow: "0 0 340px 340px rgb(94, 0, 188)",
          opacity: 0.6,
        });
      }
    });

    gsap.from('.left-shadow', {
      stagger: 0.1,
      duration: 1.2,
      opacity: 0,
      width: 0,
      ...
      onComplete: () => {
        gsap.to('.left-shadow', {
          stagger: 0.1,
          duration: 1,
          boxShadow: "0 0 413px 413px #98ff98",
          opacity: 0.6,
        });
      }
    });

    gsap.from('.bottom-shadow', {
      stagger: 0.1,
      duration: 1.4,
      opacity: 0,
      width: 0,
      ...
      backgroundColor: "transparent",
      onComplete: () => {
        gsap.to('.bottom-shadow', {
          stagger: 0.1,
          duration: 1.4,
          boxShadow: "0 0 540px 540px #e97451",
          opacity: 0.5,
          borderRadius: "50%"
        });
      }
...
<body>
  <nav class="navbar">
    <div class="buttons-wrapper">
      <a href="/about-me" class="navbar-button">About Me</a>
  ...
  <div class="header-wrapper">
    <h1 class="header">Hello, i am Vlad</h1>
    <a href="/about-me" class="about-me">about me</a> 
  </div>
</body>